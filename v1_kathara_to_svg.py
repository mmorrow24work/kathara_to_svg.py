...
'''
    ...
    def _create_title(self) -> str:
        ...
        return f'''
  <!-- Title -->
  <text x="{self.width/2}" y="30" text-anchor="middle" font-family="Arial, sans-serif" font-size="20" font-weight="bold" fill="#333">
    {lab_name}
  </text>
  <text x="{self.width/2}" y="50" text-anchor="middle" font-family="Arial, sans-serif" font-size="14" fill="#666">
    {lab_desc}
  </text>
'''
  ...
  <text x="{(node1.x + node2.x)/2}" y="{(node1.y + node2.y)/2 - 5}" 
        text-anchor="middle" font-family="Arial, sans-serif" font-size="10" fill="{color}">
...
'''
  ...
  <g transform="translate({legend_x}, {legend_y})">
    <text x="0" y="0" font-family="Arial, sans-serif" font-size="16" font-weight="bold" fill="#333">Legend:</text>
    
    <!-- Router legend -->
    <circle cx="15" cy="25" r="12" fill="#FF9800" stroke="#E65100" stroke-width="1"/>
    <text x="35" y="30" font-family="Arial, sans-serif" font-size="12" fill="#333">Router</text>
    
    <!-- PC legend -->
    <rect x="5" y="40" width="20" height="12" rx="2" fill="#607D8B" stroke="#37474F" stroke-width="1"/>
    <text x="35" y="49" font-family="Arial, sans-serif" font-size="12" fill="#333">PC/Host</text>
    
    <!-- Server legend -->
    <rect x="5" y="60" width="20" height="12" rx="2" fill="#9C27B0" stroke="#6A1B9A" stroke-width="1"/>
    <text x="35" y="69" font-family="Arial, sans-serif" font-size="12" fill="#333">Server</text>
    
    <!-- Ring connection legend -->
    <line x1="10" y1="85" x2="30" y2="85" stroke="#2196F3" stroke-width="2"/>
    <text x="35" y="89" font-family="Arial, sans-serif" font-size="12" fill="#333">Ring Connection</text>
    
    <!-- P2P connection legend -->
    <line x1="10" y1="105" x2="30" y2="105" stroke="#4CAF50" stroke-width="2" stroke-dasharray="3,3"/>
    <text x="35" y="109" font-family="Arial, sans-serif" font-size="12" fill="#333">LAN Connection</text>
    
    <!-- Hub legend -->
    <circle cx="15" cy="125" r="4" fill="#FFC107" stroke="#F57C00" stroke-width="1"/>
    <text x="35" y="129" font-family="Arial, sans-serif" font-size="12" fill="#333">Network Hub</text>
  </g>
'''
